...
class ReportRequest(BaseModel):
    target_type: Literal["user", "bottle", "treehole", "reply"]
    target_id: str
...
class PlazaCreateRequest(BaseModel):
    ...
    media_type: Literal["text", "image", "voice", "video"] = "image"
    media_count: int = 0
...
class AdminContentOut(BaseModel):
    id: str
    type: Literal["bottle", "treehole", "plaza"]
    status: ContentStatus
    author_id: str
    excerpt: str
    created_at: str
